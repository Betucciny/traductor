...
def get_data_loader(file_name):
    ...
    print("Tokenizing & Padding src DATA_DIR...")
    src_list = process_src(src_text_list) # (sample_num, L)
    print(f"The shape of src DATA_DIR: {np.shape(src_list)}")

    print("Tokenizing & Padding trg DATA_DIR...")
    input_trg_list, output_trg_list = process_trg(trg_text_list) # (sample_num, L)
    print(f"The shape of input trg DATA_DIR: {np.shape(input_trg_list)}")
    print(f"The shape of output trg DATA_DIR: {np.shape(output_trg_list)}")
